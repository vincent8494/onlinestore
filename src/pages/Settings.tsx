...
import { ArrowLeft, Bell, Lock, User, Palette } from 'lucide-react';
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <Button variant="outline" className="p-4 h-auto flex-col">
                      <div className="w-8 h-8 rounded bg-black mb-2"></div>
                      Dark
                    </Button>
                    <Button variant="outline" className="p-4 h-auto flex-col">
                      <div className="w-8 h-8 rounded bg-gradient-to-br from-background to-black mb-2"></div>
                      Auto
                    </Button>
                  </div>
                </div>
