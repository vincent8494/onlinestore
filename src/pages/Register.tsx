        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <div className="text-left">
              <h1 className="text-2xl font-bold text-primary">VMK Store</h1>
              <p className="text-sm text-muted-foreground">Buy & Sell Marketplace</p>
            </div>
          </Link>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, accountType: value as 'buyer' | 'seller' }))}
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    disabled={loading}
                  />
                  <Label htmlFor="agreeTerms" className="text-sm leading-4">
                    I agree to the{' '}
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    disabled={loading}
                  />
                  <Label htmlFor="agreeMarketing" className="text-sm leading-4">
