...
import { ArrowLeft, Upload, PackagePlus, ImagePlus } from 'lucide-react';
    ...
    <PageShell>
      <div className="mb-8 flex items-center gap-4 animate-fade-up">
        ...
        <div className="flex items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-mint text-white shadow-lift-sm">
      ...
      <div className="mx-auto max-w-2xl">
        <SectionCard title="Product Information" description="Tell buyers what you're selling" icon={PackagePlus} hue="teal">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="group rounded-2xl border-2 border-dashed border-border p-8 text-center transition-colors hover:border-brand-violet hover:bg-brand-violet/5">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-violet/10 transition-transform duration-300 group-hover:scale-110">
                  <ImagePlus className="h-7 w-7 text-brand-violet" />
                </div>
